function Player(team, geometry, material) {
...
Player.prototype.clone = function(object) {
	...
	object.canJump = this.canJump;
	object.fly = this.fly;
	object.cameraHeight = this.cameraHeight;
	object.jumpHeight = this.jumpHeight;
	object.health = this.health;
	object.maxHealth = this.maxHealth;
	object.constrainVerticalLook = this.constrainVerticalLook;
	object.inverseLook.copy(this.inverseLook);
	object.mouseSensitivity.copy(this.mouseSensitivity);
	object.velocity.copy(this.velocity);
	object.acceleration.copy(this.acceleration);
	object.ambientFriction.copy(this.ambientFriction);
	object.ambientAirFriction.copy(this.ambientAirFriction);
